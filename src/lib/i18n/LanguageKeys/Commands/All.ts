...
export * as Eshop from '#lib/i18n/LanguageKeys/Commands/Eshop';
export * as Horoscope from '#lib/i18n/LanguageKeys/Commands/Horoscope';
export * as Igdb from '#lib/i18n/LanguageKeys/Commands/Igdb';
export * as Itunes from '#lib/i18n/LanguageKeys/Commands/Itunes';
export * as Movies from '#lib/i18n/LanguageKeys/Commands/Movies';
...
export * as Shows from '#lib/i18n/LanguageKeys/Commands/Shows';
